#!/usr/bin/env sh
# Universal installer for vendorvet. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/vendorvet.git"
echo "Installing vendorvet ..."
