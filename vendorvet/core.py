"""VENDORVET core — Third-party / vendor risk questionnaires with SBOM cross-ref."""
...
RULES = [
    ("VEN-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("VEN-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("VEN-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
